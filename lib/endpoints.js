...
const endpoints = {
  ...
  download: {
    cobaltApiJson: firstNonEmpty(process.env.COBALT_API_JSON, "https://api.cobalt.tools/api/json"),
  ...
  images: {
    unsplashRandom: firstNonEmpty(process.env.UNSPLASH_RANDOM_URL, "https://source.unsplash.com/random"),
    // Privacy-friendly image proxy (avoid unofficial DDG scrape endpoints by default)
    // Expects a URL like: https://source.unsplash.com/random/1080x1080/?cats
    randomFallbackBase: firstNonEmpty(process.env.IMAGE_RANDOM_FALLBACK_BASE, "https://source.unsplash.com/random"),
