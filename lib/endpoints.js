...
const endpoints = {
  ...
  youtube: {
    // All public Invidious instances are currently dead or geo-blocked.
    // yt-dlp is the sole working download method. Override via INVIDIOUS_INSTANCES env if needed.
